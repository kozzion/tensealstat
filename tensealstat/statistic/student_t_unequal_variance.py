...
class StudentTEqualVariance(AbstractStatistic):
    ...
    def encrypt_statistic(self, algebra:AbstractAlgebra, list_sample):
        ...
        variance_0_pow = variance_0 * variance_0 * variance_0 * variance_0
        ...
        statistic_encrypted = {}
        statistic_encrypted['type_statistic'] = 'student_t_equal_variance'
    ...
    def decrypt_statistic(self, algebra:AbstractAlgebra, statistic_encrypted):
        if not statistic_encrypted['type_statistic'] == 'student_t_equal_variance':
        ...
        degrees_of_freedom_scale = statistic_encrypted['degrees_of_freedom_scale']
